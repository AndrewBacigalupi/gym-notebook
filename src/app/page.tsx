    ...
    <div className="flex min-h-full flex-col bg-zinc-50">
      <header className="border-b border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
          <span className="text-lg font-semibold text-zinc-900">Gym Notebook</span>
      ...
      <main className="mx-auto flex max-w-3xl flex-1 flex-col justify-center px-4 py-20 sm:px-6">
        ...
        <p className="mt-4 text-lg leading-relaxed text-zinc-600">
          Log every set, track personal records with a fair strength score, and review your history
          without the noise.
        </p>
